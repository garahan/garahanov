  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <nav className="flex items-center gap-0.5 rounded-full border border-white/10 bg-[#0B0C10]/70 p-1 backdrop-blur-2xl">
          {LINKS.map((l) => {
            ...
            return (
              <Link
                ...
                href={l.href}
                className={[
                  "qg-tap rounded-full px-2.5 py-1.5 text-[10px] uppercase tracking-[0.2em] transition-colors duration-500 sm:px-3",
                  active
